    ...
    <div>
      ...
      <div className="my-10 flex flex-col md:flex-row gap-10 justify-center mb-28 text-sm">
        ...
        <div className="flex flex-col justify-center gap-6 items-start">
          ...
          <p className="text-gray-500">MediConnect+  
123 Innovation Tower, Tech Park  

<br />Bengaluru, Karnataka – 560001  
India</p>
          <p className="text-gray-500">Email: support@mediconnectplus.com</p>
          <p className="font-semibold text-lg text-gray-600 uppercase">Careers at MediConnect+</p>
